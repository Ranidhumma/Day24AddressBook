...
public class Addressbook {
	...
	public static void main(String[] args) {
		...
		while (!isExit) {
			...
			/*
			 * Here we used switch case to chosse opton
			 */
			switch (option) {
			case "1":
				addContact(scanner);
	...
	/* addcontact method created , where we can add person detail in addressbook */
	...
	/*
	 * editcontact method created , where we can edit person detail in addressbook
	 */
	...
	/*
	 * deletecontact method created , where we can delete person detail in
	 * addressbook
	 */
	...
	/*
	 * Here we created showcontacts method created , where we can dispaly detail in
	 * addressbook
	 */
	...
	/*
	 * Here we are validating firstname ,Lastname , phone num, city , Zip , emial ,
	 * state etc here we are using Regex Pattern to validate below details
	 */
	...
	public static String validateLastName(String lastName, Scanner scanner) {
		...
		while (!inputMatcher.matches()) {
			System.out.println("Error: Invalid first name, please try again");
			System.out.println("length must not exceeds 10 (Exa: Pooja)");
